...
/**************************************************************
 * 
 * SEULE difference par rapport a demo1_cng, l'utilisation de
 * la fonction cng_refresh_window() (swap screen non auto)
 *
 **************************************************************/
...
int main(int argc, char** argv)
{
  ...
  cng_init_window("Minigraph Test", WSIZE, HSIZE, TRUE, FALSE);
